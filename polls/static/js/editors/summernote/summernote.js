...
(function (factory) {
  ...
  var Editor = function () {
    ...
    this.fontSize = function ($editable, sValue) {
      ...
      if (agent.bFF) {
        // firefox: <fonts size="3"> to <span style='fonts-size={sValue}px;'>, buggy
        $editable.find('fonts[size=3]').removeAttr('size').css('font-size', sValue + 'px');
      } else {
        // chrome: <span style="fonts-size: medium"> to <span style='fonts-size={sValue}px;'>
  ...
  var Renderer = function () {
    ...
    tplToolbarInfo = {
      ...
      color: function (lang) {
        return '<button type="button" class="btn btn-default btn-sm btn-small note-recent-color" title="' + lang.color.recent + '" data-event="color" data-value=\'{"backColor":"yellow"}\' tabindex="-1"><i class="fa fa-fonts icon-fonts" style="color:black;background-color:yellow;"></i></button>' +
