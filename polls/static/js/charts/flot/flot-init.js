...
var InitiateAnnotationChart = function () {
    return {
        init: function () {
            ...
            placeholder.append("<div style='position:absolute;left:" + (o.left + 4) + "px;top:" + o.top + "px;color:" + themethirdcolor + ";fonts-size:smaller'>Warming up</div>");

            o = plot.pointOffset({ x: 8, y: -1.2 });
            placeholder.append("<div style='position:absolute;left:" + (o.left + 4) + "px;top:" + o.top + "px;color:" + themefourthcolor + ";fonts-size:smaller'>Actual measurements</div>");
